	...
	public static void main(String[] args) {
		...
		do {
			...
			case 9:
				...
				try {
					List<Customer> customersByGenderList = service.getCustomerByGender(gender);
			...
			case 11:
				...
				break;
			default: System.out.println("Invalid choice... Please enter any option between 1-11 only");
				break;
